    ...
    Game.prototype = {
      ...
      draw: function() {
        ...
        if (this.lost) {
          ...
          screen.fillText('Level: ' + this.level, gameSize.width - 12, gameSize.height - 24);
          screen.fillText('Points: ' + kills, gameSize.width - 12, gameSize.height - 12);
        }
